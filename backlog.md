...
- [X] **2.3. Autenticação por PIS/CPF + Senha (Desktop / Estações de Trabalho)**
...
- [X] **3.1. Modal do Ticket Virtual de Ponto**
...
- [X] **3.2. Ações do Comprovante (Imprimir, Enviar por E-mail, Salvar)**
